<template>
  <el-card>
      ...
      <img class='head-upload' :src="formData.photo?formData.photo :photo " alt="">
        </el-upload>
 </el-card>
</template>
...
export default {
  data () {
    return {
      ...
      photo: require('../../assets/img/melo.gif'),
      rules: {
        name: [{ require: true, messsage: '用户名不能为空', trigger: 'blur' },
          { min: 1, max: 7, messsage: '用户名的长度为1-7位', trigger: 'blur' }
        ],
        email: [
